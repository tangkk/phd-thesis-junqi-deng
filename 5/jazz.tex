...
% missing a figure here (probably figure for the Markov model)
...
% here it's better to show some examples of chord-scale estimated lead sheets from GaryBurton's backings, for example..
