...
\chapter{A Preliminary Approach to Automate Jazz Chord-Scale Estimation and Automatic Jazz Improvisation}\label{cp:jazz} % top level followed by section, subsection
