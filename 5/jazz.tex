...
% FIXME:missing a figure here (probably figure for the Markov model)
...
% FIXME: here it's better to show some examples of chord-scale estimated lead sheets from GaryBurton's backings, for example..
% use the result of the hackathon
