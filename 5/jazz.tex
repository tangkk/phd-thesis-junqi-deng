...
\section{Automatic Jazz Chord Estimation}
...
Table~\ref{tab:5-aceconfig} shows all ACE configurations considered in the experiment. These are chosen based on the results in Chapter~\ref{cp:ghmm}.
\begin{table}
\centering
\footnotesize
...
%The jazz vocabulary systems have the same system framework as the SeventhsBass systems, but their deep learning models are trained using JazzGuitar99 dataset.
...
All systems are tested using the combination of GaryBurton7 and JazzGuitar99 dataset.
...
\subsubsection{Contour Separation}
...
\subsubsection{The Final Mapping}
...
\section{Put It Together}\label{sec:5-puttogether}
