...
\end{equation}
The template-based local scale estimation has been implemented during the Hackathon of ISMIR 2016 \footnote{https://github.com/tangkk/chordscale/blob/master/chordscale.py}. Figure~\ref{fig:5-chordscale} shows a demo of the output of this process with ``Olhos de Gato'', where the labels in red indicate the estimated scales.
\begin{figure}[h]
    \centering
        \includegraphics[width=0.6\columnwidth]{5/figures/chordscale-demo.pdf}
