...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.8\columnwidth, height=0.2\columnwidth]{2/figures/sheetmusic.PNG}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.7\columnwidth, height=0.3\columnwidth]{2/figures/leadsheet.PNG}
...
\section{Research Gaps} \label{sec:2-summary}
