...
\begin{figure}[htb]
\centering
\includegraphics[width=0.4\columnwidth, height=0.12\columnwidth]{2/figures/chordtabs.PNG}
\caption{Chord tabs - The Girl From Ipanema}
\label{fig:2-chordtabs}
\end{figure}

\newpage
\section{Review of Automatic Chord Estimation Design} \label{sec:2-review}
...
\subsubsection{Template Matching with Post-Filtering}
...
\subsubsection{Gaussian Mixture with Hidden Markov Model}
\begin{figure}[htb]
\centering
...
\subsubsection{Deep Learning in ACE}
...
\subsubsection{Consideration for Small Vocabulary}
...
\subsubsection{Consideration for Large Vocabulary} \label{sec:2-largevocab}
...
\subsubsection{The Output Format}
